...
const SuporteHumanizadoAlt = () => {
  return (
    <section
      id="suporte"
      className="relative flex min-h-[min(90vh,720px)] max-md:min-h-[70vh] items-center justify-center overflow-hidden py-20 max-md:py-14 md:py-28"
    >
      <div
        role="img"
        aria-label="Suporte humanizado — atendimento próximo"
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url(${imgatendimento})` }}
      />
      <div
      ...
      <div className="relative z-10 mx-auto max-w-4xl space-y-6 px-4 text-center max-md:space-y-5 md:space-y-8">
        ...
        <motion.p
          ...
          className="mx-auto max-w-2xl text-base leading-relaxed text-white max-md:text-balance md:text-lg"
        >
        ...
        >
          <Button
            size="lg"
            className="rounded-full px-8 text-base shadow-glow max-md:mx-auto max-md:min-h-12 max-md:w-full max-md:max-w-sm"
            asChild
          >
