...
const AboutUs = () => {
  return (
    <section
      id="resolve"
      className="relative scroll-mt-24 overflow-hidden py-20 max-md:py-14 md:py-28"
    >
      <div
        role="img"
      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-2">
        <div className="mx-auto max-w-4xl space-y-6 text-center lg:ml-auto lg:mr-0 lg:max-w-3xl lg:text-left">
